                                ...
                                <div class="os-col slider-col left-col">
                                    ...
                                    <div class="owl-carousel owl-carousel-1">
                                        ...
                                        ?>
                                                    <div class="item">
                                                        <?php
                                                        if (!empty($button_links[$slider_index])) {
                                                        ?>
                                                            <a href="<?php echo esc_url($button_links[$slider_index]); ?>">
                ...
                ?>
                    <span class="os-fields-wrapper">
                        ...
                        <span class="os-fields">
                            ...
                            <input class="widefat" type="text" id="<?php echo esc_attr($this->get_field_id('button_titles') . $i); ?>" name="<?php echo esc_attr($this->get_field_name('button_titles')); ?>[]" value="<?php if (!empty($instance['button_titles'][$i])) {
                            ...
                            <input class="widefat" type="text" id="<?php echo esc_attr($this->get_field_id('button_links') . $i); ?>" name="<?php echo esc_attr($this->get_field_name('button_links')); ?>[]" value="<?php if (!empty($instance['button_links'][$i])) {
